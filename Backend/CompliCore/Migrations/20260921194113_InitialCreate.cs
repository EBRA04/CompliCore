        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IqamaNumber = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ComplianceItems_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ComplianceItems_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    ComplianceItemId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documents_ComplianceItems_ComplianceItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_ComplianceItems_ComplianceItemId",
                        column: x => x.ComplianceItemId,
                        principalTable: "ComplianceItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComplianceItems_EmployeeId",
                table: "ComplianceItems",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_ComplianceItems_TenantId_ExpiryDate",
                table: "ComplianceItems",
                columns: new[] { "TenantId", "ExpiryDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Documents_ComplianceItemId",
                table: "Documents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_TenantId_IqamaNumber",
                table: "Employees",
                columns: new[] { "TenantId", "IqamaNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Notifications_ComplianceItemId_Threshold_ExpiryDateSnapshot",
                table: "Notifications",
                columns: new[] { "ComplianceItemId", "Threshold", "ExpiryDateSnapshot" },
                unique: true);
